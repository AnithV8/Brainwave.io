 ...
 * Slug: blockskit-startup/template-order-confirmation
 * Categories: template
 * Inserter: false
 */
...
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Order Confirmation', 'blockskit-startup' ); ?></h1>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Order details', 'blockskit-startup' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Downloads', 'blockskit-startup' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Shipping address', 'blockskit-startup' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Billing address', 'blockskit-startup' ); ?></h3>
<!-- /wp:heading -->
